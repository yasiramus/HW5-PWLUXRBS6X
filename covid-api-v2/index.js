...
let importationInstance = async () => {
    const conn = await mongoose.connect('mongodb://localhost:27017/covid-importantionInstance', {
...
// function call to import connect mongo instance and import importationInstance
importationInstance();
